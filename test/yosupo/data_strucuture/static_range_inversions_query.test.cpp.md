...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_strucuture/static_range_inversions_query.test.cpp\"\
    ...
    */\n#line 5 \"test/yosupo/data_strucuture/static_range_inversions_query.test.cpp\"\
    \nint main(){\n  INT(n,q);\n  vector<int>a(n);\n  cin>>a;\n  Mo mo(n);\n  rep(i,q){\n\
    \    INT(l,r);\n    mo.add(l,r);\n  }\n  vector<int>b=a;\n  sort(b.begin(),b.end());\n\
  ...
  verifiedWith: []
documentation_of: test/yosupo/data_strucuture/static_range_inversions_query.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/data_strucuture/static_range_inversions_query.test.cpp
- /verify/test/yosupo/data_strucuture/static_range_inversions_query.test.cpp.html
