...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/data_strucuture/staticrmq.test.cpp\"\n#define\
    ...
    \ Sparse Table\n*/\n#line 4 \"test/yosupo/data_strucuture/staticrmq.test.cpp\"\
    \nint main(){\n  int n,q;\n  cin>>n>>q;\n  vector<int>a(n);\n  cin>>a;\n  auto\
    \ st=MakeSparseTable(a,[](int a,int b){return min(a,b);});\n  while(q--){\n  \
  ...
  verifiedWith: []
documentation_of: test/yosupo/data_strucuture/staticrmq.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/data_strucuture/staticrmq.test.cpp
- /verify/test/yosupo/data_strucuture/staticrmq.test.cpp.html
